  ...
  try {
    ...
    const invRows = await db
      .select({
        ...
        item_mitigationFlat: items.mitigationFlat,
        item_skiruBonuses: items.skiruBonuses,
        item_skiruMaluses: items.skiruMaluses,
        item_craftExclusiveClassId: items.craftExclusiveClassId,
    ...
    const mappedItems = invRows
      ...
      .map((row) => {
        const itemRow = {
          ...
          mitigationFlat: row.item_mitigationFlat ?? null,
          skiruBonuses: row.item_skiruBonuses ?? null,
          skiruMaluses: row.item_skiruMaluses ?? null,
          craftExclusiveClassId: row.item_craftExclusiveClassId ?? null,
        ...
        return {
          ...
          item: {
            ...
            mitigationFlat: itemRow.mitigationFlat ?? null,
            skiruBonuses: itemRow.skiruBonuses ?? null,
            skiruMaluses: itemRow.skiruMaluses ?? null,
            craftExclusiveClassId: itemRow.craftExclusiveClassId ?? null,
