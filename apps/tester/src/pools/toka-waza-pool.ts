...
export const TOKA_WAZA_POOL: WazaDef[] = [
  ...
  makeActive(
    ...
    'Hi o Tsumugu (火を紡ぐ) — Filatura della Fiamma',
    "Non si colpisce: si aspetta. L'analista tiene il Tōrō immobile e fila Jigo-Ka nel vaso, quarto dopo quarto, come chi versa olio nelle lanterne dei defunti senza fretta.",
    'Attiva · [Energetico][Contatto] · Tier 2 · CS 2 · 1/4 (fino a +2 quarti immobile in carica). Colpo a contatto: danno = tier [Energetico][Contatto]. Se [Arma Psichica]: +1 tier. Per ogni quarto extra passato immobile a caricare: +1 tier (max 2 quarti). Dopo il colpo l\'arma non può lanciare waza per 1 turno.',
    { costCs: 2, costJigo: () => 5, hasDamage: true },
  ),
  makeActive(
    B,
    'kaeribi-fiamma-del-ritorno',
    'Kaeribi (帰り火) — Fiamma del Ritorno',
    "Come le lanterne che il fiume restituisce alla riva, l'analista chiama a sé ciò che ha già acceso in battaglia. Un filo d'Ego tira attraverso l'aria il Tōrō perduto verso il palmo.",
    "Attiva · [Nessuna] · CS 1 · 1/4. Richiami un'arma che hai impugnato in precedenza durante il combattimento, entro 8 m, se è ancora un tuo [Costrutto] integro. L'arma vola verso di te e torna in mano. Se [Arma Psichica]: gittata del richiamo raddoppiata (16 m).",
    { costCs: 1, costJigo: () => 3, hasDamage: false },
  ),
  makeActive(
    B,
    'tomoshibi-no-ato-traccia-della-luce',
    'Tomoshibi no Ato (灯し火の跡) — Traccia della Luce',
    "Il fendente passa e non si chiude. Lungo la traiettoria resta una linea sottile di luce morente — il solco che una lanterna lascia sull'acqua quando è già scivolata via.",
    'Attiva · [Propagazione][Energetica] · Tier 2 · CS 2 · 1/4. Fendente con l\'arma impugnata: lascia una cicatrice energetica linea 8 m per 3 turni. Chi la attraversa subisce danno = tier [Energetico]. La lunghezza può variare con la taglia dell\'arma (Master). Una cicatrice attiva alla volta (base).',
    { costCs: 2, costJigo: () => 5, hasDamage: true, durata: 'tre_turni' },
  ),
  makeActive(
    B,
    'toro-nagashi-lanterna-alla-corrente',
    'Tōrō Nagashi (灯籠流し) — Lanterna alla Corrente',
    "L'analista allenta la presa e il Tōrō scivola via come nel rito delle acque: una brace lasciata alla corrente che non chiede più di essere portata, solo di trovare chi accenderà il prossimo passo.",
    ...
    { costCs: 2, costJigo: () => 6, hasDamage: true },
  ),
]
