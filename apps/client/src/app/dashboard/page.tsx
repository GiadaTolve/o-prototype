  ...
  return (
    <div className="h-screen md:h-screen flex flex-col overflow-hidden">
      <DashboardHeader
        ...
        />
      <div className="dashboard-main-row flex-1 flex flex-col lg:flex-row lg:items-stretch gap-4 p-4 max-w-[2200px] w-full mx-auto min-h-0 overflow-y-auto lg:overflow-hidden overscroll-y-contain">
        <DashboardLeftCol
          char={char}
