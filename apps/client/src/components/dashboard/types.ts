export type WindowId = "scheda" | "presenti" | "sms" | "fetch" | "banca" | "mercato" | "housing" | "profilo" | "waza" | "dojo" | "ordine" | "bestiario" | "notifiche" | "spazioEventi" | "combattimento" | "note";
...
export type CharacterSummary = {
  ...
  /** Pixel-icon (25×25) per ruolo/ordine/premio — vedi GAME_LAYOUT_SPEC, pixel-icons.ts */
...
export type Presente = {
  ...
  isShadow?: boolean;
  /** Pixel-icon (25×25) accanto al nome — GAME_LAYOUT_SPEC */
  pixelIcons?: { ruolo?: string[]; ordine?: string[]; premioSpeciale?: string[] };
