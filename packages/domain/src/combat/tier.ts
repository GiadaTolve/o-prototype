...
export const TIER_TABLE: readonly TierRow[] = [
  { tier: 1, value: 4, csCost: 2, minGrade: 'Nemuribito', expToLearn: 3 },
  { tier: 2, value: 8, csCost: 4, minGrade: 'Hakyō', expToLearn: 6 },
  { tier: 3, value: 12, csCost: 6, minGrade: 'Bunsekikan', expToLearn: 12 },
  { tier: 4, value: 17, csCost: 8, minGrade: 'Sentatsu Bunsekikan', expToLearn: 24 },
  { tier: 5, value: 23, csCost: 10, minGrade: "Kanteikan / Shin'enkan", expToLearn: 48 },
] as const
